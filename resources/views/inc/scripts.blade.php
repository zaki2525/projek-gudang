...
@switch($page_name)
    ...
    <script src="{{asset('plugins/master/project.js')}}"></script>
    {{-- Forms Select2 --}}
    ...
    @case('barang-show')
    <script src="{{asset('plugins/master/barang-show.js')}}"></script>
    {{-- Components Sweetalerts --}}
      <script src="{{asset('assets/js/scrollspyNav.js')}}"></script>
      <script src="{{asset('plugins/sweetalerts/sweetalert2.min.js')}}"></script>
      <script src="{{asset('plugins/sweetalerts/custom-sweetalert.js')}}"></script>
    ...
    @case('transaksi')
    <script src="{{asset('plugins/master/transaksi.js')}}"></script>
    {{-- Forms Select2 --}}
    <script src="{{asset('assets/js/scrollspyNav.js')}}"></script>
    <script src="{{asset('plugins/select2/select2.min.js')}}"></script>
    <script src="{{asset('plugins/select2/custom-select2.js')}}"></script>
    ...
    <script src="{{asset('plugins/master/transaksi-history.js')}}"></script>
    {{-- Forms Select2 --}}
    <script src="{{asset('assets/js/scrollspyNav.js')}}"></script>
    <script src="{{asset('plugins/select2/select2.min.js')}}"></script>
    <script src="{{asset('plugins/select2/custom-select2.js')}}"></script>
    ...
    <script src="{{asset('plugins/master/suratjalan-history.js')}}"></script>
    <script>
        // preview image
        function previewImage() {
            const image = document.querySelector("#image");
    ...
    <script>
        $('#html5-extension').DataTable( {
            ...
            "stripeClasses": [],
            "lengthMenu": [7, 10, 20, 50, 100, 250, 500],
            "pageLength": 7
        } );
    </script>
      @break
